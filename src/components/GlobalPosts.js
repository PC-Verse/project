        ...
        return (
            <div className="everything" >
                ...
                <div id="communityswitch" className="card">
                    <button id="btnSwitch" onClick={() => this.props.toggleComponent("showApple")}><img src={appleLogo} className="companyLogos" /></button>
                    <button id="btnSwitch" onClick={() => this.props.toggleComponent("showNvidia")}><img src={nvidiaLogo} className="companyLogos" /></button>
                    <button id="btnSwitch" onClick={() => this.props.toggleComponent("showAMD")} ><img src={amdLogo} className="companyLogos" /></button>
                    <button id="btnSwitch" onClick={() => this.props.toggleComponent("showHP")} ><img src={hpLogo} className="companyLogos" /></button>
                    <button id="btnSwitch" onClick={() => this.props.toggleComponent("showIntel")} ><img src={intelLogo} className="companyLogos" /></button>
                    <button id="btnSwitch" onClick={() => this.props.toggleComponent("showMicrosoft")} ><img src={microsoftLogo} className="companyLogos" /></button>
                    <button id="globalBtnSwitch" onClick={() => this.props.toggleComponent("showGlobalPosts")} >Global</button>
                </div>
                {
